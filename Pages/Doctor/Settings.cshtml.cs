        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            try
            {
                ...
                if (userResult.Succeeded)
                {
                    ...
                    _logger.LogInformation($"Doctor profile updated for user {user.Id}");
                }
                else
                {
            ...
            {
                _logger.LogError(ex, $"Error updating doctor profile for user {user.Id}");
            ...
            try
            {
                ...
                <body>
                    <div class='container'>
                        ...
                        <div class='content'>
                            <p>Hello <strong>Dr. {displayName}</strong>,</p>
